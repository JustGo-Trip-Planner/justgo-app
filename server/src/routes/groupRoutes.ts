...
import { createGroup, deleteGroup, getGroupById, getMyGroups, updateGroup, inviteMember, leaveGroup, removeInviteMember, respondInvite, getGroupTripHistory, moveTripToHistory } from "../controllers/groupController";
...
router.get("/:id/history", verifyToken, getGroupTripHistory);
router.post("/:id/archive", verifyToken, moveTripToHistory);
