...
export default function OverviewTab({ plan }: Props) {
  ...
  const formatTHB = (amount: number) => `฿${Number(amount || 0).toLocaleString("th-TH")}`;
      ...
      <View className="rounded-3xl border border-gray-200 bg-white px-5 py-5 shadow-sm">
        <View className="mb-4 flex-row items-center justify-between">
          <View className="flex-1 pr-3">
            <Text className="text-sm font-sans text-gray-500">สรุปแผนการเดินทาง</Text>
        ...
        <View className="flex-row flex-wrap justify-between">
          <View className="mb-3 w-[48%] rounded-2xl bg-gray-50 px-4 py-4">
            <View className="flex-row items-center">
              ...
              <Text className="ml-2 text-sm font-sans text-gray-500">วันที่เดินทาง</Text>
            </View>
          ...
          <View className="mb-3 w-[48%] rounded-2xl bg-gray-50 px-4 py-4">
            <View className="flex-row items-center">
              ...
              <Text className="ml-2 text-sm font-sans text-gray-500">งบประมาณ</Text>
            </View>
            <Text className="mt-2 text-lg font-semibold text-gray-900">
          ...
          <View className="w-[48%] rounded-2xl bg-gray-50 px-4 py-4">
            <View className="flex-row items-center">
              ...
              <Text className="ml-2 text-sm font-sans text-gray-500">ระดับที่พัก</Text>
            </View>
            <Text className="mt-2 text-lg font-semibold text-gray-900">
          ...
          <View className="w-[48%] rounded-2xl bg-gray-50 px-4 py-4">
            <View className="flex-row items-center">
              ...
              <Text className="ml-2 text-sm font-sans text-gray-500">จำนวนสถานที่ท่องเที่ยว</Text>
            </View>
            <Text className="mt-2 text-lg font-semibold text-gray-900">
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          {(plan.recommended_hotels || []).map(
            (
              ...
              <View
                key={idx}
                className="mr-4 w-[220px] overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm"
              >
                <Image
                  source={{
                    uri: hotel.image || "https://via.placeholder.com/300x200",
                  }}
                ...
                <View className="p-4">
                  {!!hotel.type && (
                    <View className="mb-2 self-start rounded-full bg-sky-50 px-3 py-1">
